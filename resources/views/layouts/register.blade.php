                                    ...
                                    <div class="row gy-3 overflow-hidden">
                                        <div class="col-12">
                                            <div class="form-floating mb-3">
                                                ...
                                                @error('name')
                                                    <!-- FIXED: Corrected the HTML for the error message -->
                                        ...
                                        <div class="col-12">
                                            <div class="form-floating mb-3">
                                                <!-- FIXED: Changed name and id to be 'password_confirmation' (all lowercase) -->
                                                <input type="password" class="form-control" name="password_confirmation" id="password_confirmation" placeholder="Confirm Password" >
                                                <!-- FIXED: The 'for' attribute now correctly points to 'password_confirmation' -->
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="d-flex gap-2 gap-md-4 flex-column flex-md-row justify-content-center">
                                            <a href="{{ route('login') }}" class="link-secondary text-decoration-none">or click here to login</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
