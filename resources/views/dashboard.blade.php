...
<head>
    ...
    <style>
        body {
            ...
            padding-bottom: 100px; /* Increased padding for the floating bottom navigation */
        }
        .gradient-bg {
        ...
        /* Floating effect for bottom navigation bar */
...
@keyframes scroll-left {
    ...
    100% {
        /* Move left by half the content container's width.
           Since you have duplicated the content, moving by 50% of the combined width
           will bring the start of the duplicated content to the original start point,
...
.horizontal-scroll-container {
    ...
    /* You might want to add padding-left/right if you want space at the ends */
    padding-left: 1rem;
    padding-right: 1rem;
}
...
.horizontal-scroll-container > div {
    ...
    width: 350px; /* Example fixed width for each card. Adjust as needed. */
    /* Ensure your cards have a defined width so they don't just fill the container */
}
...
/* Existing styling for the glass effect and 3D card hover, if not already present */
.glass-effect {
    background: rgba(255, 255, 255, 0.1); /* Semi-transparent white */
    backdrop-filter: blur(10px); /* Blur effect */
    border: 1px solid rgba(255, 255, 255, 0.2); /* Light border */
...
<body class="bg-gray-900 text-white relative">
    ...
    <audio id="clickSound" src="{{ asset('sound/click.mp3') }}" autoplay='Sound' preload="auto"></audio>

    <!-- Navigation - Moved to bottom and fixed -->
    

    <!-- Announcement Bar - Adjusted margin-top -->
                        ...
                        <div class="bg-gradient-to-br from-green-600 to-teal-600 h-80 rounded-xl flex items-center justify-center relative overflow-hidden">
                            ...
                            <div class="text-center relative z-10">
                                <div class="w-20 h-20 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-6 interactive-element">
                                    <!-- Checkmark icon updated for minimalist feel -->
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="marquee-wrapper">
                <div class="marquee-content-container">
                    <!-- Original Set -->
                    <div class="marquee-item text-center feature-card-3d">
                        <div class="glass-effect h-16 rounded-xl flex items-center justify-center interactive-element">
                            <span class="text-white font-bold text-lg">🏠 Happy Tails</span>
                        </div>
                    </div>
                    <div class="marquee-item text-center feature-card-3d">
                        <div class="glass-effect h-16 rounded-xl flex items-center justify-center interactive-element">
                            <span class="text-white font-bold text-lg">🏥 PetCare Clinic</span>
                        </div>
                    </div>
                    <div class="marquee-item text-center feature-card-3d">
                        <div class="glass-effect h-16 rounded-xl flex items-center justify-center interactive-element">
                            <span class="text-white font-bold text-lg">🎓 Paws Academy</span>
                        </div>
                    </div>
                    <div class="marquee-item text-center feature-card-3d">
                        <div class="glass-effect h-16 rounded-xl flex items-center justify-center interactive-element">
                            <span class="text-white font-bold text-lg">🛒 Pet Paradise</span>
                        </div>
                    </div>
                    <div class="marquee-item text-center feature-card-3d">
                        <div class="glass-effect h-16 rounded-xl flex items-center justify-center interactive-element">
                            <span class="text-white font-bold text-lg">✂️ Furry Friends</span>
                        </div>
                    </div>
                    <div class="marquee-item text-center feature-card-3d">
                        <div class="glass-effect h-16 rounded-xl flex items-center justify-center interactive-element">
                            <span class="text-white font-bold text-lg">🐾 Loving Paws</span>
                        </div>
                    </div>
                    <!-- Duplicated Set 1 - Essential for seamless loop -->
                    <div class="marquee-item text-center feature-card-3d">
                        <div class="glass-effect h-16 rounded-xl flex items-center justify-center interactive-element">
                            <span class="text-white font-bold text-lg">🏠 Happy Tails</span>
                        </div>
            ...
            <div class="horizontal-scroll-container">
                <div class="text-center card-hover feature-card-3d fade-in-scroll">
                    <div class="glass-effect rounded-2xl p-8 h-full">
                        <div class="bg-green-600/20 w-20 h-20 rounded-2xl flex items-center justify-center mx-auto mb-8 interactive-element">
                            <!-- Star icon for "Find Your Perfect Pet" -->
                            <svg class="w-10 h-10 text-green-400" fill="currentColor" viewBox="0 0 24 24">
                                <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/>
                            </svg>
                        </div>
                        <h3 class="text-2xl font-bold mb-6">Find Your Perfect Pet</h3>
                        <p class="text-gray-300 text-lg">Browse hundreds of pets available for adoption from verified shelters. Find your new best friend with detailed profiles and health records.</p>
                    </div>
                </div>
                ...
                <div class="text-center card-hover feature-card-3d fade-in-scroll">
                    <div class="glass-effect rounded-2xl p-8 h-full">
                        <div class="bg-blue-600/20 w-20 h-20 rounded-2xl flex items-center justify-center mx-auto mb-8 interactive-element">
                            <!-- User icon for "Connect with Local Services" -->
                            <svg class="w-10 h-10 text-blue-400" fill="currentColor" viewBox="0 0 24 24">
                                <path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/>
                            </svg>
                        </div>
                        <h3 class="text-2xl font-bold mb-6">Connect with Local Services</h3>
                        <p class="text-gray-300 text-lg">Find trusted veterinarians, trainers, groomers, and pet stores in your area. Read reviews and book appointments directly through our platform.</p>
                    </div>
                </div>

                <div class="text-center card-hover feature-card-3d fade-in-scroll">
                    <div class="glass-effect rounded-2xl p-8 h-full">
                        <div class="bg-purple-600/20 w-20 h-20 rounded-2xl flex items-center justify-center mx-auto mb-8 interactive-element">
                            <!-- Chat bubble icon for "Join Our Community" -->
                        ...
                        <p class="text-gray-300 text-lg">Connect with fellow pet owners, share experiences, ask questions, and get advice from our supportive community of pet lovers.</p>
                    </div>
                </div>
            </div>
        </div>
...
<body>
    ...
    {{-- <div class="content">
        ...
        <p>This is the main content of your welcome page.</p>
    </div> --}}
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-20 fade-in-scroll">
                <h2 class="text-5xl md:text-6xl font-bold mb-8 text-shadow">
                    Complete <span class="text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-teal-400">pet care</span> solutions
                </h2>
                <p class="text-xl text-gray-300 max-w-4xl mx-auto">
                    From finding your perfect companion to comprehensive care, LittleFur connects you with everything your pet needs to live their best life.
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                <div>
                    ...
                    <div class="space-y-8">
                        <div class="flex items-start space-x-6 card-hover fade-in-scroll">
                            <div class="w-16 h-16 bg-gradient-to-br from-green-500 to-teal-500 rounded-full flex items-center justify-center interactive-element">
                                <span class="text-white text-2xl">🐕</span>
                            </div>
                            <div>
                                <h4 class="font-bold text-xl mb-2">Pet Adoption</h4>
                                <p class="text-gray-400 text-lg">Find your perfect companion from verified shelters</p>
                            </div>
                        </div>
                        <div class="flex items-start space-x-6 card-hover fade-in-scroll">
                            <div class="w-16 h-16 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-full flex items-center justify-center interactive-element">
                                <span class="text-white text-2xl">🏥</span>
                            </div>
                            <div>
                                <h4 class="font-bold text-xl mb-2">Healthcare Services</h4>
                                <p class="text-gray-400 text-lg">Connect with veterinarians and health specialists</p>
                            </div>
                        </div>
                        <div class="flex items-start space-x-6 card-hover fade-in-scroll">
                            <div class="w-16 h-16 bg-gradient-to-br from-purple-500 to-pink-500 rounded-full flex items-center justify-center interactive-element">
                                <span class="text-white text-2xl">🎓</span>
                            </div>
                            <div>
                                <h4 class="font-bold text-xl mb-2">Training & Education</h4>
                                <p class="text-gray-400 text-lg">Professional training and educational resources</p>
                            </div>
                        </div>
                        <div class="flex items-start space-x-6 card-hover fade-in-scroll">
                            <div class="w-16 h-16 bg-gradient-to-br from-orange-500 to-red-500 rounded-full flex items-center justify-center interactive-element">
                                <span class="text-white text-2xl">🛒</span>
                            </div>
                            <div>
                                <h4 class="font-bold text-xl mb-2">Supplies & Grooming</h4>
                                <p class="text-gray-400 text-lg">Everything your pet needs for health and happiness</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="tilt-card-inner">
                        <div class="space-y-8">
                            <div class="flex items-start space-x-6">
                                <div class="w-16 h-16 bg-gradient-to-br from-green-500 to-teal-500 rounded-full flex-shrink-0 flex items-center justify-center interactive-element">
                                    <span class="text-white text-2xl">🐾</span>
                                </div>
                                <div class="bg-gray-600/50 rounded-xl p-6 flex-1">
                                    <p class="text-lg font-semibold mb-3">Max - Golden Retriever</p>
                                    <p class="text-gray-300 mb-2">3 years old • Vaccinated • Great with kids</p>
                                    <p class="text-sm text-gray-400">Available for adoption at Happy Tails Shelter</p>
                                </div>
                            </div>
                            <div class="flex items-start space-x-6">
                                <div class="w-16 h-16 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-full flex-shrink-0 flex items-center justify-center interactive-element">
                                    <span class="text-white text-2xl">🏥</span>
                                </div>
                                <div class="bg-gray-600/50 rounded-xl p-6 flex-1">
                                    <p class="text-lg font-semibold mb-3">Dr. Sarah Johnson</p>
                                    <p class="text-gray-300 mb-2">Veterinarian • 4.9★ Rating</p>
                                    <p class="text-sm text-gray-400">Available for appointments this week</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section class="py-24 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 relative overflow-hidden">
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10 fade-in-scroll">
            ...
            <p class="text-2xl mb-12 text-blue-100">
                Join thousands of happy pet owners who found their companions through LittleFur
            </p>
            <div class="flex flex-col sm:flex-row gap-6 justify-center">
                <button class="bg-white text-blue-600 px-12 py-6 rounded-xl text-xl font-bold hover:bg-gray-100 transition-all hover:scale-105 neon-glow interactive-element">
                    Start Your Search
                </button>
                <button class="glass-effect text-white px-12 py-6 rounded-xl text-xl font-bold transition-all hover:scale-105 interactive-element">
                    Browse Services
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-12">
            ...
            <div class="col-span-1 md:col-span-1">
                <div class="flex items-center space-x-3 mb-6">
                    <!-- Dog Paw Logo SVG in Footer -->
                    <div class="w-10 h-10 bg-gradient-to-br from-green-500 to-teal-500 rounded-full flex items-center justify-center neon-glow">
                        <svg class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M12 2c-2.76 0-5 2.24-5 5s2.24 5 5 5 5-2.24 5-5-2.24-5-5-5zm-3 13c-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4-1.79-4-4-4zm6 0c-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4-1.79-4-4-4z"/>
                        </svg>
                    </div>
                    <h3 class="text-2xl font-bold text-white text-shadow">LittleFur</h3>
                </div>
                <p class="text-gray-400 text-lg mb-4">Your complete pet services platform.</p>
            ...
            <div class="col-span-1 md:col-span-1">
                ...
                <ul class="space-y-3">
                    <li><a href="Adopt" class="text-gray-400 hover:text-white transition-colors duration-300">Adopt a Pet</a></li>
                    <li><a href="Hospital" class="text-gray-400 hover:text-white transition-colors duration-300">Pet Hospitals</a></li>
                    <li><a href="Shelter" class="text-gray-400 hover:text-white transition-colors duration-300">Shelters</a></li>
                    <li><a href="Community" class="text-gray-400 hover:text-white transition-colors duration-300">Community Forum</a></li>
            ...
            <!-- Services -->
            <div class="col-span-1 md:col-span-1">
                <h4 class="text-xl font-bold text-white mb-6">Services</h4>
                <ul class="space-y-3">
                    <li><a href="#" class="text-gray-400 hover:text-white transition-colors duration-300">Pet Training</a></li>
                    <li><a href="#" class="text-gray-400 hover:text-white transition-colors duration-300">Grooming</a></li>
                    <li><a href="#" class="text-gray-400 hover:text-white transition-colors duration-300">Pet Supplies</a></li>
                    <li><a href="#" class="text-gray-400 hover:text-white transition-colors duration-300">Virtual Consultations</a></li>
                    <li><a href="#" class="text-gray-400 hover:text-white transition-colors duration-300">Emergency Care</a></li>
                </ul>
            </div>

            <!-- Stay Connected -->
            <div class="col-span-1 md:col-span-1">
                <h4 class="text-xl font-bold text-white mb-6">Stay Connected</h4>
                <p class="text-gray-400 mb-4">Follow us on social media for updates and pet tips!</p>
                <div class="flex space-x-6">
                    ...
                    <a href="#" class="text-gray-400 hover:text-white transition-colors duration-300">
                        <svg class="w-7 h-7" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                            <path fill-rule="evenodd" d="M12.315 2c2.43 0 2.784.002 3.797.048.843.04 1.15.138 1.504.237.664.189 1.154.462 1.612.92.458.459.722.942.91 1.6.098.354.197.661.237 1.503.046 1.014.048 1.371.048 3.797v.001c0 2.43-.002 2.784-.048 3.797-.04.844-.138 1.15-.237 1.504-.189.664-.462 1.154-.92 1.612-.459.458-.942.722-1.6.91-.354.098-.661.197-1.503.237-1.014.046-1.371.048-3.797.048h-.001c-2.43 0-2.784-.002-3.797-.048-.843-.04-1.15-.138-1.504-.237-.664-.189-1.154-.462-1.612-.92-.458-.459-.722-.942-.91-1.6-.098-.354-.197-.661-.237-1.503-.046-1.014-.048-1.371-.048-3.797v-.001c0-2.43.002-2.784.048-3.797.04-.843.138-.115.237-1.504.189-.664.462-1.154.92-1.612.459-.458.942-.722 1.6-.91.354-.098.661-.197 1.503-.237 1.014-.046 1.371-.048 3.797-.048zm0 1.637c-3.284 0-3.743.015-4.778.064-.95.045-1.4.24-1.717.34-.67.215-1.16.59-1.575 1.005-.415.415-.79 1.005-1.005 1.575-.1.317-.294.767-.34 1.717-.049 1.035-.064 1.494-.064 4.778 0 3.284.015 3.743.064 4.778.045.95.24 1.4.34 1.717.215.67.59 1.16 1.005 1.575.415.415 1.005.79 1.575 1.005.317.1.767.294 1.717.34 1.035.049 1.494.064 4.778.064s3.743-.015 4.778-.064c.95-.045 1.4-.24 1.717-.34.67-.215 1.16-.59 1.575-1.005.415-.415-1.005-.79-1.575-1.005-.317-.1-.767-.294-1.717-.34-1.035-.049-1.494-.064-4.778-.064zM12 6.865a5.135 5.135 0 100 10.27 5.135 5.135 0 000-10.27zm0 1.637a3.5 3.5 0 110 7 3.5 3.5 0 010-7z" clip-rule="evenodd" />
                        </svg>
                    </a>
                    <a href="#" class="text-gray-400 hover:text-white transition-colors duration-300">
                        <svg class="w-7 h-7" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                            <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.007-.532A8.318 8.318 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.073 4.073 0 01.8 10.42c-.004.05-.004.1-.004.15 0 4.445 3.17 8.138 7.368 8.995a4.075 4.075 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.077a11.616 11.616 0 006.29 2.174z" />
                        </svg>
                    </a>
                </div>
            </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const bottomNavBar = document.getElementById('bottomNavBar'); // Get the nav bar
            ...
            // --- Mute Button Logic ---
            // Initial state check for the audio element
            clickSound.muted = false; // Ensure it's not muted by default unless specified
            updateMuteButtonIcon(); // Set initial icon

            muteButton.addEventListener('click', () => {
                clickSound.muted = !clickSound.muted; // Toggle mute state
            ...
            window.addEventListener('scroll', () => {
                ...
                if (window.scrollY > lastScrollY && window.scrollY > 100) { // Scrolling down and past initial offset
                    bottomNavBar.classList.add('hide-nav');
                } else { // Scrolling up or at the very top
                    bottomNavBar.classList.remove('hide-nav');
                }

                // Set a timeout to show the nav bar if scrolling stops
